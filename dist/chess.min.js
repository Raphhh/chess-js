...
var Chess = function() {
    ...
    return a.Movement = a.Movement || {}, a.Movement.Coordinator = function() {
        function b(b) {
            this.__internal__ = {board: b, calculator: new a.Movement.DisplacementsCalculator(b)}
        }

        return b.prototype.moveTo = function(a, b) {
            if(!this.isEligibleMove(a, b))throw new Error("Try an invalid move");
            this.__internal__.board.changePiecePosition(a, b), a.incrementDisplacementsNumber()
        ...
        }, b.prototype.isEnPassantCaptureOpen = function(b, c) {
            return b instanceof a.Piece.Type.Pawn ? b.getSquare().getPosition().getY() === c.getY() - 2 : !1
        }, b.prototype.getEligibleSquares = function(a) {
            return this.__internal__.calculator.getEligibleSquares(a)
        }, b
    }(), a
}(Chess || {}), Chess = function(a) {
    "use strict";
    ...
    return a.Piece = a.Piece || {}, a.Piece.Type = a.Piece.Type || {}, a.Piece.Type.Pawn = function() {
        ...
        return b.prototype.getName = function() {
            ...
            return[new a.Movement.Displacement(0, this.getColor().isWhite() ? 1 : -1, function() {
                return!b.__internal__.displacementsNumber && ++c < 2
            }, function(a) {
                return!a.getPiece()
