...
var Chess = function() {
    ...
    return a.Movement = a.Movement || {}, a.Movement.Coordinator = function() {
        ...
        return b.prototype.moveTo = function(a, b) {
            ...
            for(var c, d, e = new a.Movement.Mover(b.getSquare().getPosition(), b.getDisplacementsSuite()), f = [], g = !1; null !== (c = e.moveOnce(g));) {
                try {
                    d = this.__internal__.board.getSquareByPosition(c)
                } catch(h) {
                    d = null
                }
                d && d.isValidForNewPiece(b) ? (f.push(d), g = !e.getCurrentDisplacement().isExtensible() || d.getPiece()) : g = !0
            }
            return f
        }, b
    }(), a
    ...
    return a.Movement = a.Movement || {}, a.Movement.Mover = function() {
        ...
        return b.prototype.moveOnce = function(b) {
            if(b) {
                if(++this.__internal__.currentDirectionId >= this.__internal__.displacementsSuite.length)return null;
    ...
    return a.Piece = a.Piece || {}, a.Piece.Type = a.Piece.Type || {}, a.Piece.Type.Pawn = function() {
        ...
        return b.prototype.getName = function() {
            ...
            return[new a.Movement.Displacement(0, this.getColor().isWhite() ? 1 : -1, !1)]
        }, b
    }(), a
}(Chess || {}), Chess = function(a) {
    "use strict";
