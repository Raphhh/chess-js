...
var Chess = function() {
    ...
    return a.Board = a.Board || {}, a.Board.Board = function() {
        ...
        return b.prototype.getSquareByPosition = function(a) {
            ...
            for(var c = new a.Piece.PieceFactory, d = 0, e = b.length; e > d; ++d) {
                var f = c.createByData(b[d]);
                b[d].position && b[d] ? this.addPiece(f, new a.Movement.Position(b[d].position.x, b[d].position.y)) : this.__internal__.pieces.push(f)
            }
