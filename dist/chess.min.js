...
var Chess = function() {
    ...
    return a.Game = function() {
        function b(b) {
            var c = new a.Board.Board;
            c.initPieces(b.pieces), this.__internal__ = {board: c, coordinator: new a.Movement.Coordinator(c)}
        }
    ...
    return a.Movement = a.Movement || {}, a.Movement.Coordinator = function() {
        function b(b) {
            this.__internal__ = {board: b, calculator: new a.Movement.DisplacementsCalculator(b), enPassantContext: new a.Movement.EnPassantContext(new a.Movement.EnPassantCoordinator(b), new a.Movement.PawnDisplacementAnalyser)}
        }

        return b.prototype.moveTo = function(a, b) {
            if(!this.isEligibleMove(a, b))throw new Error("Try an invalid move");
            this.__internal__.enPassantContext.synchronizeContextBeforeDisplacement(a, b), this.__internal__.board.changePiecePosition(a, b), a.incrementDisplacementNumber()
    ...
    return a.Movement = a.Movement || {}, a.Movement.Displacement = function() {
        ...
        }, a.prototype.isExtensible = function() {
            return this.__internal__.isExtensible instanceof Function ? this.__internal__.isExtensible() : this.__internal__.isExtensible
    ...
    "use strict";
    return a.Movement = a.Movement || {}, a.Movement.DisplacementType = function() {
        function a(a, b) {
            this.vectors = a, this.isExtensible = b
        }
    ...
    return a.Movement = a.Movement || {}, a.Movement.DisplacementsCalculator = function() {
        ...
        return b.prototype.getEligibleSquares = function(b) {
            ...
            for(var c, d, e = new a.Movement.Mover(b.getSquare().getPosition(), b.getDisplacementsSuite()), f = []; null !== (c = e.moveOnce());) {
                try {
                    d = this.__internal__.board.getSquareByPosition(c)
                } catch(g) {
                    d = null
                }
                d && d.isValidForNewPiece(b) && e.getCurrentDisplacement().isValid(d) ? (f.push(d), (!e.getCurrentDisplacement().isExtensible() || d.getPiece()) && e.changeDirection()) : e.changeDirection()
            }
            return f
        }, b
    }(), a
    ...
    return a.Piece = a.Piece || {}, a.Piece.Piece = function() {
        function a(a) {
            this.__internal__ = {color: a, square: null, displacementNumber: 0}
        }
        ...
        return a.prototype.getName = function() {
            ...
            return[]
        }, a.prototype.incrementDisplacementNumber = function() {
    ...
    return a.Piece = a.Piece || {}, a.Piece.PieceFactory = function() {
        ...
        return b.prototype.create = function(b, d) {
            return new (a.Piece.Type[c(b)])(new a.Piece.Color(d))
        }, b.prototype.createByData = function(a) {
            return this.create(a.type, a.color)
        }, b
    }(), a
}(Chess || {}), Chess = function(a) {
    "use strict";
    return a.Piece = a.Piece || {}, a.Piece.Type = a.Piece.Type || {}, a.Piece.Type.Bishop = function() {
        function b(a) {
            this.__super__.constructor.call(this, a)
        }
    ...
    return a.Piece = a.Piece || {}, a.Piece.Type = a.Piece.Type || {}, a.Piece.Type.Pawn = function() {
        ...
        return b.prototype.getName = function() {
            ...
            var b = this, c = 0;
            return[new a.Movement.Displacement(0, this.getColor().isWhite() ? 1 : -1, function() {
                return!b.__internal__.displacementNumber && ++c < 2
            }, function(a) {
                return!a.getPiece()
            }), new a.Movement.Displacement(-1, this.getColor().isWhite() ? 1 : -1, !1, function(a) {
    ...
    "use strict";
    return a.Simulator = a.Simulator || {}, a.Simulator.EligibleSquare = function() {
        function a(a) {
            this.__internal__ = {square: a}
        }

        return a.prototype.getValue = function() {
            return this.__internal__.getPiece() ? this.__internal__.getPiece().getValue() : 0
        }, a.prototype.isBetterThan = function(a) {
            return a ? this.getValue() > a.getValue() : !0
        }, a
    }(), a
}(Chess || {}), Chess = function(a) {
    "use strict";
    return a.Simulator = a.Simulator || {}, a.Simulator.GameState = function() {
        function b(a) {
            this.__internal__ = {game: a}
        }

        return b.prototype.getMovablePieces = function() {
            for(var b = [], c = this.__internal__.game.getBoard().getPieces(), d = 0, e = c.length; e > d; ++d) {
                var f = this.__internal__.game.getCoordinator().getEligibleSquares(c[d]);
                f.length && b.push(new a.Simulator.MovablePiece(c[d], f))
            }
            return b
        }, b.prototype.getBestMovablePiece = function() {
            for(var a = null, b = this.getMovablePieces(), c = 0, d = b.length; d > c; ++c)b[c].isBetterThan(a) && (a = b[c]);
            return a
        }, b
    }(), a
}(Chess || {}), Chess = function(a) {
    "use strict";
    return a.Simulator = a.Simulator || {}, a.Simulator.MovablePiece = function() {
        function b(a, b) {
            this.__internal__ = {piece: a, eligibleSquares: b}
        }

        return b.prototype.getEligibleSquares = function() {
            for(var b = [], c = this.__internal__.eligibleSquares, d = 0, e = c.length; e > d; ++d)b.push(new a.Simulator.EligibleSquare(c[d]));
            return b
        }, b.prototype.getBestEligibleSquare = function() {
            for(var a = null, b = this.getEligibleSquares(), c = 0, d = b.length; d > c; ++c)b[c].isBetterThan(a) && (a = b[c]);
            return a
        }, b.prototype.isBetterThan = function(a) {
            return a ? this.getBestEligibleSquare().getValue() > a.getBestEligibleSquare().getValue() : !0
        }, b
    }(), a
}(Chess || {});