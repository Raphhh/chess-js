...
var Chess = function() {
    ...
    return a.Movement = a.Movement || {}, a.Movement.Coordinator = function() {
        ...
        return b.prototype.moveTo = function(a, b) {
            ...
            this.__internal__.board.changePiecePosition(a, b)
            ...
            for(var c, d, e = new a.Movement.Mover(b.getSquare().getPosition(), b.getDisplacementType().vectors), f = [], g = !1; null !== (c = e.moveOnce(g));) {
                try {
                    d = this.__internal__.board.getSquareByPosition(c)
                } catch(h) {
                    d = null
                }
                d && d.isValidForNewPiece(b) ? (f.push(d), g = !b.getDisplacementType().isExtensible || d.getPiece()) : g = !0
            }
            return f
        }, b
    }(), a
    ...
    return a.Movement = a.Movement || {}, a.Movement.Mover = function() {
        function b(a, b) {
            this.__internal__ = {position: a, initialPosition: a, displacements: b, currentDirectionId: 0}
        }
        ...
        return b.prototype.moveOnce = function(b) {
            if(b) {
                if(++this.__internal__.currentDirectionId >= this.__internal__.displacements.length)return null;
                this.__internal__.position = this.__internal__.initialPosition
            }
            return this.__internal__.position = new a.Movement.Position(c.call(this), d.call(this)), this.__internal__.position
        }, b
    }(), a
}(Chess || {}), Chess = function(a) {
    "use strict";
    ...
    return a.Piece = a.Piece || {}, a.Piece.Piece = function() {
        function a(a) {
            this.__internal__ = {color: a, square: null}
        }
        ...
        }, a.prototype.getDisplacementType = function() {
            return null
        }, a
    }(), a
}(Chess || {}), Chess = function(a) {
    ...
    return a.Piece = a.Piece || {}, a.Piece.Type = a.Piece.Type || {}, a.Piece.Type.Bishop = function() {
        ...
        return b.prototype.getName = function() {
            return"B"
        }, b.prototype.getDisplacementType = function() {
            return new a.Movement.DisplacementType([
                {x: 1, y: 1},
                {x: 1, y: -1},
                {x: -1, y: -1},
                {x: -1, y: 1}
