...
var Chess = function() {
    ...
    return a.Board = a.Board || {}, a.Board.Board = function() {
        ...
        return b.prototype.getSquareByPosition = function(a) {
            ...
            for(var c = new a.Piece.PieceFactory, d = new a.Movement.PositionFactory, e = 0, f = b.length; f > e; ++e)b[e].position ? this.addPiece(c.createByData(b[e]), d.createByData(b[e].position)) : this.addPiece(c.createByData(b[e]))
        }, b.prototype.addPiece = function(a, b) {
            b && this.changePiecePosition(a, b), this.__internal__.pieces.push(a)
    ...
    return a.Movement = a.Movement || {}, a.Movement.Coordinator = function() {
        function b(b, c) {
            this.__internal__ = {board: b, colorSwitcher: new a.Piece.ColorSwitcher(c), calculator: new a.Movement.DisplacementsCalculator(b), enPassantContext: new a.Movement.Pawn.EnPassantContext(new a.Movement.Pawn.EnPassantCoordinator(b), new a.Movement.Pawn.PawnDisplacementAnalyser)}
        }
        ...
        return b.prototype.getPlayingColor = function() {
            ...
            if(!this.__internal__.colorSwitcher.isPlayingColor(a.getColor()))return[];
    ...
    "use strict";
    return a.Movement = a.Movement || {}, a.Movement.Pawn = a.Movement.Pawn || {}, a.Movement.Pawn.EnPassantContext = function() {
        function b(a, b) {
    ...
    "use strict";
    return a.Movement = a.Movement || {}, a.Movement.Pawn = a.Movement.Pawn || {}, a.Movement.Pawn.EnPassantCoordinator = function() {
        function b(a) {
    ...
    "use strict";
    return a.Movement = a.Movement || {}, a.Movement.Pawn = a.Movement.Pawn || {}, a.Movement.Pawn.PawnDisplacementAnalyser = function() {
        function b() {
        }
    ...
    "use strict";
    return a.Movement = a.Movement || {}, a.Movement.PositionFactory = function() {
        function b() {
        }

        return b.prototype.createByData = function(b) {
            return new a.Movement.Position(b.x, b.y)
        }, b
    }(), a
}(Chess || {}), Chess = function(a) {
    "use strict";
