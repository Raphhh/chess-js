...
var Chess = function() {
    ...
    return a.Movement = a.Movement || {}, a.Movement.Coordinator = function() {
        ...
        return b.prototype.moveTo = function(a, b) {
            ...
            this.__internal__.enPassantContext.synchronizeContextBeforeDisplacement(a, b), this.__internal__.board.changePiecePosition(a, b), a.incrementDisplacementsNumber()
    ...
    return a.Piece = a.Piece || {}, a.Piece.Type = a.Piece.Type || {}, a.Piece.Type.Pawn = function() {
        ...
        return b.prototype.getName = function() {
            ...
            var b = this, c = 0;
            return[new a.Movement.Displacement(0, this.getColor().getDirection(), function() {
